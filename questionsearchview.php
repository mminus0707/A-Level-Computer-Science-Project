...
//checking the session variable's value if there are no items found the error message will be displayed
if ($_SESSION['SearchRes'] != "No items were found"){
//creating the table for the questions to be displayed
...
$sql = $_SESSION['SearchRes'];

$res = $mysqli->query($sql);
//entering all of the results
